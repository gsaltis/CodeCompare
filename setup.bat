...
doskey co2=release\CodeCompare -1 D:\Source\NCUCodeMerge\Track2_NCU_Code\src\mainapp\main -2 D:\Source\NCUCodeMerge\Track3_NCU_Code\G3\src\mainapp\main -a -s System.json $*
