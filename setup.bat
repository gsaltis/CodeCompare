...
doskey co2=release\CodeCompare -1 C:\users\greg.saltis\Source\NCUCodeMerge\Track3_NCU_Code-master\G3\src -2 C:\users\greg.saltis\Source\NCUCodeMerge\Track2_NCU_Code-master\src $*
