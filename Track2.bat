...
CALL :build sampler\can_sampler can_inverter.c
...
CALL :build sampler\can_sampler can_smduhh.c
...
CALL :build sampler\rs485_sampler rs485_hdu.c
CALL :build sampler\rs485_sampler rs485_iplu.c
...
CALL :build service\lcd_ui problem_qt_fifo.c
CALL :build service\lcd_ui qt_fifo.c
CALL :build service\lcd_ui_mini lcd_ack_dlg.c
CALL :build service\lcd_ui_mini lcd_alarms_screen.c
CALL :build service\lcd_ui_mini lcd_default_screen.c
CALL :build service\lcd_ui_mini lcd_item_handle.c
CALL :build service\lcd_ui_mini lcd_language_screen.c
CALL :build service\lcd_ui_mini lcd_main.c
CALL :build service\lcd_ui_mini lcd_menu_screen.c
CALL :build service\lcd_ui_mini lcd_password_dlg.c
CALL :build service\lcd_ui_mini lcd_signals_screen.c
CALL :build service\lcd_ui_mini test_lcd_module.c
...
CALL :build service\web_user cgi_filemanage_ESNA.c
...
CALL :build service\web_user web_egy_sav.c
...
CALL :build systemhandler handler.c
CALL :build systemhandler smain.c
EXIT /B %ERRORLEVEL%
